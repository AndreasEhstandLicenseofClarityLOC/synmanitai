...
> **WICHTIG / IMPORTANT:** Dieser Disclaimer muss auf JEDER Publikation, JEDEM Tool, JEDER Website, JEDEM Artikel erscheinen.
> This disclaimer MUST appear on EVERY publication, EVERY tool, EVERY website, EVERY article.
...
**§21 License (CC BY-NC-ND 4.0).** All content is published under the Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International License. Attribution required, commercial use prohibited, derivative works not permitted. Full license text: creativecommons.org/licenses/by-nc-nd/4.0/.
